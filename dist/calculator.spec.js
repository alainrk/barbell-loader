...
for (const c of cases) {
    tap_1.default.test(`Barbell: ${c.bbw}, Target: ${c.tw}, Imbalance: ${c.imb}, Fails: ${c.throws}`, (t) => {
        try {
            const res = (0, calculator_1.calculate)(c.bbw, c.tw, JSON.parse(JSON.stringify(c.aw)), c.imb);
